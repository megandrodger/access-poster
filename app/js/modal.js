...
//$("#simpleColoursModalLink").on("click", function () {
  //  $("#simpleColoursBack").focus();
 //});


//Trapping the focus inside modal (works for tab only)----------
//$("#simpleColoursClose").keydown(function (e) {
  //  if (e.which == 9) {
    //    $("#simpleColoursBack").focus();
      //  e.preventDefault();
    //}
